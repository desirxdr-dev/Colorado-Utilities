...
try {
  ...
  return message.reply(`<:check:1485791925935013960> **Successfully** sent message to <@${userId}>.`);
} catch (err) {
  console.error("DM command error:", err);
  return message.reply("<:xMark:1485791953307308223> **Failed** to **message** user.");
}
